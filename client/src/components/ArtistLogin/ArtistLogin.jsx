    ...
    return (
        ...
        <div className="auth-form-container bg-slate-400 bg-opacity-75 md:bg-opacity-75 justify-center w-96">
            ...
            <form className="login-form" onSubmit={handleSubmit}>
                ...
                <NavLink
                    to="/ArtistForgotPassword"
                    className="forgot text-2xl">
                    Forgot Password?
                </NavLink>
                <button className="button1 bg-blue-700" type="submit">Login</button>
            </form>

            <label htmlFor="" className="l1 text-2xl">Don't have an account?<button className="link-btn hover:text-blue-800" onClick={() => props.onFormSwitch('register')}>Register here.</button></label>
