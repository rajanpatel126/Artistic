    ...
    return (
        ...
        <div className="auth-form-container bg-slate-400 bg-opacity-75 md:bg-opacity-75 justify-center w-96 ">
            ...
            <div className="logoimg">
                ...
                <p className=" text-white text-4xl mt-1 mb-4"> Admin Register</p>
            </div>
            ...
            <form className="register-form " onSubmit={handleSubmit}>
                ...
                <label htmlFor="name"></label>
                    <input value={name} name="name" id="name" className="text-xl" placeholder="Username"></input>
                <label htmlFor="email"></label>
                    <input value={email} className="text-xl" onChange={(e) => setEmail(e.target.value)} type="email" placeholder="Mobile number or Email" id="email" name="email"></input>
                <label htmlFor="password"></label>
                    <input value={pass} onChange={(e) => setPass(e.target.value)} type="password" className="text-xl" placeholder="Password" id="password" name="password" />
