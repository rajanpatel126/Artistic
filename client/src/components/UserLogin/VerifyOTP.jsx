...
export const VerifyOTP = () => {
    ...
    return (<>
        <section className="text-gray-800 h-full body-font py-72 bg-[url('https://img.freepik.com/premium-photo/abstract-modern-black-background-black-paper-texture-black-dark-gray-textured-design-paper_183577-792.jpg')] bg-cover">
            <div className="container h-full mx-auto   ">
                ...
                <div className="box-border rounded-2xl container py-14 px-6 mx-auto  md:box-content  w-1/2 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] bg-slate-100 border-white border-2 bg-slate-400 bg-opacity-75 md:bg-opacity-75 justify-center w-96">
                    <div className="box-border container flex w-32 mb-3">
                        <img src="./images/logo1.jpeg" className="img1 justify-center items-center w-64" alt="hello" />
                        {/* <p className="mt-4 ml-2 text-4xl">Artistic</p> */}
                    </div>
                    <p className="text-Black justify-center text-center   text-4xl mt-1 px-2 font-bold">Verification Required</p>
                   
                    <div className="px-16 mx-auto ">
                        <div className="flex flex-wrap -m-2">
                            <p className="px-2 text-xl mb-4 mt-4 text-left">To continue, complete this verification step. We've sent an OTP to the mobile number. Please enter it below to complete verification.</p>
                            ...
                            <NavLink className=" flex w-full justify-center text-center mx-auto text-2xl text-blue border-0 py-2 px-8 focus:outline-none text-blue-600 rounded"
                                to="/verifyOTP"
                            >
                                Resend OTP
                            </NavLink>
