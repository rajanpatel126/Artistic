...
export const ForgotPassword = () => {
    ...
    return (<>
        <section className="text-gray-800 h-full body-font py-72 bg-slate-200 bg-[url('https://img.freepik.com/premium-photo/abstract-modern-black-background-black-paper-texture-black-dark-gray-textured-design-paper_183577-792.jpg')] bg-cover ">
