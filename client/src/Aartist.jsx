...
export default function Aartist() {
    return (
                    ...
                    <div className="flex-1">
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            <li className="rounded-sm ">
                                <NavLink to="/AddArt" className="flex items-center p-2  hover:text-white hover:bg-slate-500 space-x-3 rounded-md ">

                                    <span class="text-2xl">Add Art</span>
                                </NavLink>
                            </li>
                            ...
                            <li className="rounded-sm ">
                                ...
                                >
                                    <span class="text-2xl">View Art</span>
                                </NavLink>
