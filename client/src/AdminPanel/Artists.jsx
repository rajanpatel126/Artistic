        ...
        <div className="container h-full w-full px-5 py-10 mx-auto">
          <form className="w-full -mb-14 justify-end text-right">
            <div className="relative flex w-full justify-end text-right">
              <AiOutlineSearch className="absolute mt-4 mr-3  flex w-6 h-6  text-gray-400" />
              <input
                type="text"
                placeholder="Search"
                className="w-full py-3 lowercase  text-3xl  text-black border rounded-md outline-none bg-gray-50 focus:bg-white focus:border-indigo-600">
                </input>
            </div>
          </form>
              ...
              <tbody className="mt-5">
                <tr className="box-border border-t-8 h-24  transform hover:bg-gray-100 hover:shadow-lg">
                  ...
                  <td className="w-10 text-center text-3xl text-black px-2">
                    <div className="flex ">
                      <button className="w-32 h-14 border-2 rounded-lg py-2 bg-green-600 hover:bg-green-700 ">Accept</button>
                      <button className="w-32 h-14 border-2  ml-2 rounded-lg py-2 bg-red-500 hover:bg-red-600 ">Decline</button>
                    </div>
                  </td>
                </tr>
