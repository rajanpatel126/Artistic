...
const Kurtis = () => {
  return (
    ...
    //     {/* Sidebar */}
    // <div className="flex flex-col h-screen w-1/6 p-20 ml-60 mt-16 bg-slate-300 shadow-orange-200 ">
    //     <div className="space-y-3">
    //         <div className="flex items-center">
    //             <input type="text" className="bg-transparent text-black text-xl h-20 w-96 normal-case" placeholder="search"/>
    //         </div>
    ...
    <div className="container px-5 py-3 mx-auto">
      <div className="flex flex-wrap -m-4">
        <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
          <a className="block relative h-3/4 rounded overflow-hidden">
            <img
              alt="ecommerce"
              className=" object-cover object-center w-full h-full object-contain"
        ...
        <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
          <a className="block relative h-3/4 rounded overflow-hidden">
            <img
              alt="ecommerce"
              className="object-cover object-center w-full h-full bg-cover"
